...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['add_leader'])) {
        ...
        $sql = "INSERT INTO leaders (name, position, contacts, bio, picture) 
                VALUES ('$name', '$position', '$contacts', '$bio', '$picture')";
        if ($conn->query($sql)) {
                            ...
                            <?php if ($leaders->num_rows > 0): ?>
                                <?php while ($leader = $leaders->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($leader['contacts']) ?></td>
                                        <td>
                                            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editLeaderModal<?= $leader['id'] ?>">
                                                <i class="fas fa-edit"></i> Edit
                                            </button>
                                            <a href="update_contacts.php?delete=<?= $leader['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this leader?');">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="POST" enctype="multipart/form-data">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Contact</label>
                                                            <input type="text" name="contacts" class="form-control" value="<?= htmlspecialchars($leader['contacts']) ?>" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Bio</label>
