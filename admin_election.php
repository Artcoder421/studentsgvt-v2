...
<body>
    ...
    <div id="content">
        <header>
            ...
            <p class="lead">Control all election processes and view results</p>
        </header>
        
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card">
                    <h5><i class="fas fa-cogs"></i> Manage Elections</h5>
                    <p>Control election settings and configurations</p>
                    <a href="admin_contestants.php" class="btn btn-primary">Go</a>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card">
                    <h5><i class="fas fa-chart-bar"></i> View Results</h5>
                    <p>See current and historical election results</p>
                    <a href="election_results.php" class="btn btn-primary">Go</a>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card">
                    <h5><i class="fas fa-user-plus"></i> Upload Contestants</h5>
